...
async def reset_to_admin_only():
    async with AsyncSessionLocal() as db:
        print("🧹 1. Nettoyage intégral des données...")
        ...
        # 2. Supprimer les missions et sous-missions
        # On supprime les enfants (sous-missions) d'abord
        print("   - Suppression des sous-missions...")
        await db.execute(delete(SousMission))
        print("   - Suppression des missions...")
        ...
        await db.commit()
        print("🗑️  Base totalement vidée (sauf logs éventuels).")
        ...
        print("-" * 50)
        print("👉 Étape suivante : Lance ton script 'missions.py' pour reconstruire")
        print("   le catalogue avec les nouveaux flags RESP_ONLY.")
